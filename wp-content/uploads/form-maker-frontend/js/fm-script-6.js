    ...
    var labels_and_ids6 = {"2":"type_spinner","5":"type_spinner","1":"type_submit_reset","3":"type_spinner","4":"type_spinner"};
    var check_regExp_all6 = [];
    var check_paypal_price_min_max6 = [];
    var file_upload_check6 = [];
    var spinner_check6 = {"2":["0",""],"5":["0",""],"3":["0",""],"4":["0",""]};
...
function after_submit6() {
  ...
  jQuery("#form6 #wdform_2_element6").spinner({ min: "0"});
  ...
  jQuery("#form6 #wdform_3_element6").spinner({ min: "0"});
  ...
  jQuery("#form6 #wdform_4_element6").spinner({ min: "0"});
