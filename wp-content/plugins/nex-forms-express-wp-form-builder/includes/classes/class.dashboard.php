...
if(!class_exists('NEXForms_dashboard'))
	...
	public function submission_report(){
			...
			$sql .= 'CREATE TABLE `'.$wpdb->prefix.'wap_nex_forms_temp_report` (';	
			  ...
			  if($_POST['field_selection'])
			 	 $report->field_selection = sanitize_text_field($_POST['field_selection']);
			  $report->additional_params = sanitize_text_field($_POST['additional_params']);
			 $output .= '<div class="right-col-top">'; 
				...
				$show_cols = sanitize_text_field($_POST['showhide_fields']);
